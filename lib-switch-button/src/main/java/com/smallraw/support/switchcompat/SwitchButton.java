...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            thumbRadius = ta.getDimension(R.styleable.SwitchButton_ThumbRadius, thumbRadius);
            ...
            textThumbInset = ta.getDimensionPixelSize(R.styleable.SwitchButton_TextThumbInset, 0);
            textExtra = ta.getDimensionPixelSize(R.styleable.SwitchButton_TextExtra, 0);
            textAdjust = ta.getDimensionPixelSize(R.styleable.SwitchButton_TextAdjust, 0);
            ta.recycle();
        }
