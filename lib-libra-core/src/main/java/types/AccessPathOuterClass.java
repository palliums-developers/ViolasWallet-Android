...
public final class AccessPathOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return AccessPathOuterClass.internal_static_types_AccessPath_descriptor;
    }

    @Override
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return AccessPathOuterClass.internal_static_types_AccessPath_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AccessPath.class, Builder.class);
    }
    ...
    public static AccessPath parseFrom(
    ...
    public static AccessPath parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AccessPath parseFrom(
    ...
    public static AccessPath parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AccessPath parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AccessPath parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AccessPath prototype) {
    ...
    public static final class Builder extends
      ...
      @Override
      public AccessPath getDefaultInstanceForType() {
        return AccessPath.getDefaultInstance();
      }

      @Override
      public AccessPath build() {
        AccessPath result = buildPartial();
      ...
      @Override
      public AccessPath buildPartial() {
        AccessPath result = new AccessPath(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AccessPath) {
          return mergeFrom((AccessPath)other);
        } else {
      ...
      public Builder mergeFrom(AccessPath other) {
        if (other == AccessPath.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AccessPath parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AccessPath) e.getUnfinishedMessage();
    ...
    private static final AccessPath DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AccessPath();
    }

    public static AccessPath getDefaultInstance() {
