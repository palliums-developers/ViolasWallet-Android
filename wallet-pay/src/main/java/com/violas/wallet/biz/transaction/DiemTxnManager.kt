...
import org.palliums.libracore.http.AccountStateDTO
import org.palliums.libracore.wallet.Account

/**
 * Created by elephant on 3/24/21 10:21 AM.
 * Copyright © 2019-2020. All rights reserved.
 * <p>
 * desc:
 */
class DiemTxnManager {
    ...
    fun calculateGasInfo(
        ...
        // 计算作为gas的currency的可用金额，要减去交易出去的金额
        ...
        return DiemGasInfo(gasCurrencyCode, actualMaxGasAmount, actualGasUnitPrice)
    }
}