...
import kotlinx.android.synthetic.main.dialog_close_biometrics.*
 ...
 * desc: 关闭生物识别对话框
 */
class CloseBiometricsDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_close_biometrics, container)
    }
