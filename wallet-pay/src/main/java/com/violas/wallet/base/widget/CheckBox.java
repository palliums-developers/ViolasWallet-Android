package com.violas.wallet.base.widget;
...
public class CheckBox extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.CheckBox_style);
        size = ta.getDimensionPixelSize(R.styleable.CheckBox_style_size, dp(size));
        bitmapColor = ta.getColor(R.styleable.CheckBox_style_color_background, bitmapColor);
        borderColor = ta.getColor(R.styleable.CheckBox_style_color_border, borderColor);
        ...
        checkDrawable = context.getResources().getDrawable(R.drawable.icon_check);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        rad = rad - DensityUtility.dp2px(getContext(), 2);
    ...
    private void addAnim(boolean isChecked) {
        ...
        checkAnim.addListener(new AnimatorListenerAdapter() {
            @Override
    ...
    public void setChecked(boolean checked, boolean animated) {
        ...
        if (attachedToWindow && animated) {
            addAnim(checked);
            Log.e("=====", "attachedToWindow:" + checked);
        } else {
            cancelAnim();
            setProgress(checked ? 1.0f : 0.0f);
            Log.e("=====", "setProgress:" + checked);
        }
    }
