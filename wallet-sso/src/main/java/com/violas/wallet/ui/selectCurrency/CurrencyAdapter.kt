...
class CurrencyAdapter(
    context: Context,
    private val contactLists: ArrayList<CurrencyBean>,
    private val onClick: (CurrencyBean) -> Unit
) : RecyclerView.Adapter<CurrencyAdapter.ViewHolder>(),
    StickyHeaderAdapter<CurrencyAdapter.HeaderHolder> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = mInflater.inflate(R.layout.item_support_currency, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val (countryOrTerritory, currency, _, indicator) = contactLists[position]
        holder.itemView.tvName.text = countryOrTerritory
        holder.itemView.tvNote.text = currency
        holder.itemView.tvIndicator.text = indicator
    }
    ...
    override fun onCreateHeaderViewHolder(parent: ViewGroup): HeaderHolder {
        val view = mInflater.inflate(R.layout.item_support_currency_head, parent, false)
