...
public class LanguageShared {
    ...
    private static LanguageShared helper;
    private SharedPreferences sharedPreferences;


    private LanguageShared(Context context) {
        sharedPreferences = context.getSharedPreferences(SHARED_PATH, Context.MODE_PRIVATE);
    }

    public static LanguageShared getInstance(Context context) {
        if (helper == null) {
            helper = new LanguageShared(context);
        }
        return helper;
    }
