 ...
 */
class SSOMintTokenProgressFragment : BaseSSOMintTokenFragment() {

    override fun getLayoutResId(): Int {
        return R.layout.fragment_sso_mint_token_progress
    }

    override fun setApplicationInfo(details: SSOApplicationDetailsDTO) {
        super.setApplicationInfo(details)

        if (details.applicationStatus == SSOApplicationState.MINTED_TOKEN) {
